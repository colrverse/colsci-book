...
##### Colourspace istances with `coldist`
...
##### Estimating Colour Volumes (with $\alpha$-shapes)

Traditionally, the colour volume or "colourfulness" of an object has been estimated
by computing the volume of the convex hull containing the data points in a given colourspace, as
